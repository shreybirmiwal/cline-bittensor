...
export class Cline {
	...
	async *attemptApiRequest(previousApiReqIndex: number): ApiStream {
		...
		console.log("started attemptApiRequest")
		...
		try {
			...
			console.log("API request first chunk received", firstChunk)
			...
			if (isOpenRouter && !this.didAutomaticallyRetryFailedApiRequest) {
				...
				console.log("first chunk failed, asking user if they want to retry")
